        ...
        Citizen.CreateThread(function()
            while open do 
                ...
                for i = 1, #Garage.vehiclelist, 1 do
                    ...
                    RageUI.Button(nomvehicletexte.." | "..plaque, "Pour sortir votre Bateaux", {RightLabel = "→→→"}, true, {
                        onSelected = function()  
...
RegisterNetEvent("garage:OpenGarageMenu") AddEventHandler("garage:OpenGarageMenu", function() OpenMenuGarage() end)